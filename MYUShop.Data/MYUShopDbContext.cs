...
namespace MYUShop.Data
{
    public class MYUShopDbContext : IdentityDbContext<AppUser>
    {
        public MYUShopDbContext() : base("MYUShopConnection")
        {
        ...
        public static MYUShopDbContext Create()
        {
            return new MYUShopDbContext();
        }
